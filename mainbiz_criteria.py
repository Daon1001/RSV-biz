...
# =====================================================================
# 성과관리 — IT/소프트웨어업 (R&D·보안·자체 솔루션 보유 등 IT 특화)
# =====================================================================

PERFORMANCE_ITEMS_IT = {
    "p1": {
        "category": "performance",
        "category_name": "성과관리",
        "name": "성과지표(KPI) 설정",
        ...
        "questions": [
            {
                ...
                "options": [
                    {"label": "없음", "score": 0},
                    {"label": "매출만 관리", "score": 10},
                    {"label": "재무·고객·서비스품질·기술 등 다차원 KPI", "score": 25},
                    {"label": "OKR 또는 BSC 등 체계화된 KPI 시스템", "score": 35},
                ]
            },
            {
                "id": "p1_q2",
                "text": "팀별·개인별 KPI가 연계되어 있습니까?",
                "type": "single",
                "options": [
                    {"label": "없음", "score": 0},
                    {"label": "팀까지", "score": 10},
        ...
        "questions": [
            {
                ...
                "options": [
                    ...
                    {"label": "30% 이상 (고성장)", "score": 40},
                ]
            },
            {
                "id": "p3_q2",
                "text": "매출액 대비 R&D 투자 비율은? (IT업 핵심지표)",
                "type": "single",
                "options": [
                    {"label": "1% 미만", "score": 0},
                    {"label": "1~3%", "score": 10},
    ...
    "p4": {
        "category": "performance",
        "category_name": "성과관리",
        "name": "비재무성과 — 기술경쟁력·보안 (IT업)",
        "max": 60,
        "questions": [
            {
                "id": "p4_q1",
                "text": "자체 보유 소프트웨어·솔루션 현황은?",
                "type": "single",
                "options": [
                    {"label": "외부 솔루션 재판매만", "score": 0},
                    {"label": "커스터마이징 위주", "score": 5},
                    {"label": "자체 솔루션 1~2개 보유", "score": 20},
                    {"label": "자체 솔루션 3개 이상 + 지속 업데이트", "score": 30},
                ]
            },
            {
                "id": "p4_q2",
                "text": "IT/SW 관련 인증 보유 (중복 가능)",
                "type": "multi",
                "options": [
                    {"label": "ISO 9001", "score": 5},
                    {"label": "ISO 27001 (정보보안)", "score": 10},
                    {"label": "ISMS-P / CSAP / GS인증", "score": 10},
                    {"label": "SW품질인증·CMMI 등", "score": 5},
                ]
            },
        ],
        "evidences": [
            "보유 솔루션·서비스 목록 (자체 vs 외주)",
            "ISO 9001/27001 인증서 (해당 시)",
            "ISMS-P, CSAP, GS인증서 (해당 시)",
            "SW 저작권 등록증",
            "보안사고 이력 (해당 시)",
        ]
    },
